...
| `N3MemoryCore_v1.0.0_Pro_JP_Complete.md` | Pro版 フルセット（日本語） |
| `N3MemoryCore_v1.0.0_Pro_EN_Complete.md` | Pro版 フルセット（英語） |
| `N3MemoryCore_v1.0.0_Pro_JP_Upgrade.md` | Free→Proアップグレード用（日本語） |
| `N3MemoryCore_v1.0.0_Pro_EN_Upgrade.md` | Free→Proアップグレード用（英語） |
