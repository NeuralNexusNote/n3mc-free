...
- 🔗 **DB統合が可能** — 同じ指示書から構築したDBは、スキーマ・embeddingモデル・ベクトル形式がすべて同一。異なる環境の記憶をシームレスに統合できる、統合を前提としたDB設計です
...
Pro版の指示書は [n3mc-pro リポジトリ](https://github.com/NeuralNexusNote/n3mc-pro) にあります。
